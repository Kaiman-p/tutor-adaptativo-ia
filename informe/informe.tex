...
Hay además una razón más personal, y más actual, detrás de este
proyecto. Hoy en día es facilísimo pedirle a una IA que escriba
código, y que lo escriba bien. Pero eso mismo esconde un riesgo: si no
tienes los fundamentos, no puedes saber si lo que la IA generó hace lo
que de verdad necesitas, no puedes detectar un error sutil, ni puedes
adaptar esa solución a un caso distinto. Depender de la IA sin
entender lo que produce es quedar a ciegas de tu propio código. Por
eso quise construir una herramienta que, usando la IA como motor, me
obligara a entender los fundamentos por mi propia cuenta --- no a
saltármelos.
